      ...
      if (scoredResults.length > 0) {
        ...
        try {
          const response = await fetch('/api/generate-insights', {
            ...
            body: JSON.stringify({ l2Results: scoredResults, processName: 'Record to Report', effortData: filteredEffort, hourlyRate: loadedHourlyRate, savingPercent: loadedSavingPercent })
          })
        ...
        {activeTab === 'overview' && (
          <div>
            ...
            <div style={{ background: 'white', borderRadius: '12px', padding: '24px', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
              ...
              <p style={{ fontSize: '13px', color: '#666', marginBottom: '12px' }}>How your R2R maturity compares to Financial Services peers</p>
          ...
          <div style={{ background: 'white', borderRadius: '12px', width: '560px', maxHeight: '80vh', display: 'flex', flexDirection: 'column', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
            <div style={{ padding: '20px 24px', borderBottom: '1px solid #e5e7eb', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <p style={{ fontSize: '12px', color: '#666', margin: '4px 0 0' }}>Powered by FPI Finance Intelligence</p>
              </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: '300px' }}>
              {benchmarkChatMessages.length === 0 && (
                <div style={{ fontSize: '13px', color: '#666', fontStyle: 'italic' }}>Ask me anything about your benchmark results — e.g. "Why am I below average in a process?" or "What should I focus on to improve my score?"</div>
              )}
