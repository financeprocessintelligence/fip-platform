      ...
      <div style={{ background: '#0F2744', color: 'white', padding: '32px 40px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            {isUnlocked && <button onClick={() => router.push('/results-r2r-print')} style={{ padding: '9px 16px', background: '#1d9e75', color: 'white', border: 'none', borderRadius: '6px', fontSize: '13px', fontWeight: '600', cursor: 'pointer' }}>⬇ Download PDF Report</button>}
      ...
      <div style={{ padding: '32px 40px' }}>
        ...
        {activeTab === 'recommendations' && (isUnlocked ? (
          <div>
            ...
            <div style={{ marginBottom: '20px' }}><h3 style={{ fontSize: '18px', fontWeight: '700', color: '#1a1a2e', marginBottom: '4px' }}>Prioritised Improvement Recommendations</h3><p style={{ fontSize: '13px', color: '#666' }}>{generatingInsights ? '⏳ Generating AI recommendations...' : 'Ranked by impact and effort'}</p></div>
