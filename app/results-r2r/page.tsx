      ...
      <div className="res-header" style={{ background: '#0F2744', color: 'white', padding: '32px 40px' }}>
        ...
        {activeTab === 'recommendations' && (isUnlocked ? (
          <div>
            ...
            <div style={{ marginBottom: '20px', marginTop: '24px' }}><h3 style={{ fontSize: '18px', fontWeight: '700', color: '#1a1a2e', marginBottom: '4px' }}>Prioritised Improvement Recommendations</h3><p style={{ fontSize: '13px', color: '#666' }}>{generatingInsights ? '⏳ Generating AI recommendations...' : 'Ranked by impact and effort'}</p></div>
